...
public class LocalAiFallback {
    ...
    public static String getMockQuestionsForSubject(String contentSource, int count) {
        ...
        if (contentLower.contains("java") || contentLower.contains("jvm")) {
            ...
            mockQuestionsJson = "[\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("c programming") || contentLower.contains("malloc") || contentLower.contains("pointer")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("c++") || contentLower.contains("stl") || contentLower.contains("vector")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("sql") || contentLower.contains("join") || contentLower.contains("select")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("dbms") || contentLower.contains("acid") || contentLower.contains("normalization")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("operating system") || contentLower.contains("deadlock") || contentLower.contains("thread")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("network") || contentLower.contains("osi") || contentLower.contains("tcp")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("structure") || contentLower.contains("complexity") || contentLower.contains("dsa")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("agile") || contentLower.contains("scrum") || contentLower.contains("software engineering")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("machine learning") || contentLower.contains("classification") || contentLower.contains("neural")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
                    ...
                    "  }\n" +
                    "]";
        } else if (contentLower.contains("compiler") || contentLower.contains("parser") || contentLower.contains("syntax")) {
            mockQuestionsJson = "[\n" +
                    "  {\n" +
